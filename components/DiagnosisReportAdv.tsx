...
export default function DiagnosisReportAdv({
  ...
  return (
    // NEW COMPACT HEADER
    <div className="bg-white rounded-2xl p-5 border border-indigo-400 shadow-xl max-w-xl mx-auto">
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-slate-400 text-[9px] font-bold uppercase tracking-widest mt-1 flex items-center">
            ...
            <span className="mx-2 w-1 h-1 rounded-full bg-indigo-400 shrink-0" />
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {symptoms.map((s, i) => (
              <span
                key={i}
                className="bg-slate-50/50 text-slate-900/70 px-3 py-1 rounded-lg text-sm font-medium border border-indigo-100"
              >
            ...
            {results.map((r, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-black text-indigo-600 w-10">
                    {r.confidence}%
                  </span>
                </div>
              </div>
